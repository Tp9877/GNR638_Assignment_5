...
1. **Encoder**: Extracts features and maps them to a two-level latent space (`z1`, `z2`). Note (`z1`, `z2`) fixed to ('400','20').
...
![Generated Digits on Class 7](https://github.com/user-attachments/assets/209123cc-8ab7-43ae-92d6-430a0193890e)

### **3) VAE Trained seprately on each Class of MNIST Dataset**

<img src="https://github.com/user-attachments/assets/c76dfdc8-c810-483e-8757-a1e0c7c81a7b" alt="Generated digits of each class" width="800" height="800">
